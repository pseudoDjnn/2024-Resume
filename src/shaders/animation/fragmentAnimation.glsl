...
float sdOctahedron(vec3 p, float s) {
  ...
  float digitalWave = 0.5 - sin(abs(-uAudioFrequency * 0.005 + TAU * tan(abs(p.x * 21.0)) * p.y * 13.0 * length(fract(p.z * 13.0))) + ceil(2.144 * floor(1.08))) * 0.2 + 0.5;
